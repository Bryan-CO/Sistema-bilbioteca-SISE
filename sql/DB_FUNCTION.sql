...
CREATE OR REPLACE FUNCTION public.getlibros(
    ...
    RETURNS TABLE(libro_id integer, serial_number character varying, nombre character varying, autor character varying, "año" integer, idioma character varying, editorial character varying, categoria character varying, subgenero character varying, unidades integer, cant_paginas integer) 
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE PARALLEL UNSAFE
    ROWS 1000
